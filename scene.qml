...
Window {
    ...
    height: 1600
    visible: true
    title: "kitchen digital assistant UI"
    color: "black"
    ...
    Item {
        ...
        Row {
            ...
            Column {
                ...
                Text { color: "white"; style: Text.Outline; styleColor: "black";
                    text: "camera pos " + camX.value.toFixed(2) + " " + camY.value.toFixed(2) + " " + camZ.value.toFixed(2) }
                Slider {
                    id: camX
                    from: -360
                    to: 360
...
//        layer.samples: 8
        ...
        PerspectiveCamera {
            id: camera
            position: Qt.vector3d(camX.value, camY.value, camZ.value)
