...
//    property alias rot2: rodec_Mixetta_Rodec_Knobs_Phono1_wh.rotation
    ...
    Node {
        ...
        Model {
            ...
            y: -0.075973
            z: 0.0110243
            eulerRotation: Qt.vector3d(0, 0, rOOT.powerOn ? 0 : 40)
            ...
            pickable: true
            TapHandler {
                onPressedChanged: if (!pressed) rOOT.powerOn = !rOOT.powerOn
            }
        }
        Model {
        ...
        Model {
            ...
            PointLight { position: "0.068,0.035,0.010"; brightness: rOOT.powerOn ? 3 : 0; castsShadow: true; color: "lemonchiffon" }
            PointLight { position: "0.092,0.035,0.010"; brightness: rOOT.powerOn ? 3 : 0; castsShadow: true; color: "lemonchiffon" }
            PointLight { position: "0.145,0.035,0.010"; brightness: rOOT.powerOn ? 3 : 0; castsShadow: true; color: "lemonchiffon" }
            PointLight { position: "0.173,0.035,0.010"; brightness: rOOT.powerOn ? 3 : 0; castsShadow: true; color: "lemonchiffon" }
        }
    }
}
